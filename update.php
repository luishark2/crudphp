...
include "header.php";
?>
<h5><b><i class="fa fa-pencil"></i> Actualizar Clientes</b></h5>
</header>
<div class="row">
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <img src="imagen/<?php echo $imagenActual; ?>" alt="Imagen del Cliente" style="max-width: 150px; display: block; margin-bottom: 10px;">
